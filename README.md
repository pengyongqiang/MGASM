# MGASM
The code and dataset for paper "MGASM: Multi-granularity attribute similarity model for user alignment across social platforms under pre-aligned data sparsity"
...
[//]: # (        title = "{MGASM: Multi-level Attribute Embedding for Semi-supervised User Identity Linkage}",)
