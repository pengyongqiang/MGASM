...
def train_model(positive_example, negative_example, num_epochs=100, lr=0.02, batch_size=64, patience=20):
...
# Example usage:
# positive_data = ...  # Load positive examples
# negative_data = ...  # Load negative examples
# trained_model = train_model(positive_data, negative_data)

# To make predictions:
# input_data = ...  # Input data for prediction
# predicted_score = predict_score(trained_model, input_data)
# [100, 'MGASM', 100, True, 0.628, 0.6807, 0.7152]
# [100, 'MGASM', 200, True, 0.696, 0.7447, 0.77]
